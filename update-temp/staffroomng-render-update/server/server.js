...
// (as one line/string) — see the README for how to generate and paste it in
// as a Render environment variable. This does NOT require the Blaze plan;
// service accounts work on the free Spark plan too.
...
// The web app gets this from `await auth.currentUser.getIdToken()`.
...
// verification), so it uses express.raw() instead of express.json().
app.post(
  "/paystack-webhook",
...
// ---------- 3. Fetch contact details after a confirmed unlock ----------
